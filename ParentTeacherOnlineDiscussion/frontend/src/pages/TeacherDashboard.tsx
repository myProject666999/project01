...
import { appointmentAPI, timeSlotAPI } from '../api';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-1">管理您的预约和时间段</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="card">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm text-gray-500">可用时段</p>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div className="ml-4 flex-1">
                <p className="font-medium text-gray-900">管理时段</p>
                <p className="text-sm text-gray-500">添加、编辑或删除可用时间段</p>
              </div>
            ...
            >
              ...
              <div className="ml-4 flex-1">
                ...
                <p className="text-sm text-gray-500">查看和处理所有预约请求</p>
              </div>
              <ChevronRight className="h-5 w-5 text-gray-400" />
            </Link>
          </div>
